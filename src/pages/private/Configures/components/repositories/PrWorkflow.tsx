...
const PrWorkflow = ({ pr, workflows }: PrWorkflowPropsType) => {
  ...
  return (
    <div className="border-[0.09rem] border-gray-100 hover:border-gray-300 rounded-lg overflow-hidden shadow-sm transition-shadow cursor-pointer bg-white flex flex-col px-3 py-4 gap-2">
      <div className="flex gap-2 justify-between">
        ...
        <div className="">
          <div className="bg-[#238636] text-white rounded-xl px-3 py-[0.30rem] flex items-center justify-center gap-1 text-sm">
      ...
      <div className="flex gap-2 items-center">
        ...
        <div className="text-xs font-medium text-cgray-dtext">
      ...
      <div className="flex flex-col gap-5 mt-4">
        ...
        <div
          className={`transition-all duration-600 ease-in-out overflow-hidden flex flex-col gap-7 ${
            showWorkflow ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"
          }`}
        >
            ...
            return (
              <div key={wf.id} className="">
                ...
                <div
                  ...
                  } flex px-[0.20rem] py-2 justify-between ${
