...
import { FaCodeMerge, FaPlay, FaUsers } from "react-icons/fa6";
...
const LandingPage = () => {
  ...
  // Preload hero image before rendering
  useEffect(() => {
    const img = new Image();
    img.src = "circle_bg.png";
    img.onload = () => {
      setHeroLoaded(true);
    };
  }, []);
          ...
          <div className="absolute text-white top-[10rem] lg:top-[11rem] lg:left-[4rem] h-full flex text-[3rem] lg:text-[5.5rem] font-[800] z-10">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center justify-center mt-6">
                <button
                  className="text-sm font-normal start-button"
                  onClick={() =>
              ...
              <div className="mt-3 gap-1 flex items-center justify-center">
                <div className="relative flex items-center justify-center w-7 h-7">
                  <div
                    className="absolute inset-0 rounded-full p-[4px] animate-[spin_3s_linear_infinite]"
                    style={{
                      background:
                        "conic-gradient(from 0deg, #000000, #ffffff, #000000)",
                    }}
                  ></div>
                  <div className="relative z-10 flex items-center justify-center w-[85%] h-[85%] rounded-full bg-white">
                    <FaPlay className="text-black ml-[2px] text-[0.6rem]" />
                  </div>
                </div>
                <span className="text-[0.9rem] font-semibold text-outline">
                  Watch demo
                </span>
              </div>
            </div>
